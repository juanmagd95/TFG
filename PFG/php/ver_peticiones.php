...
$sql="SELECT * FROM alquileres WHERE ID_USER =" . $id ;
...
<tr>
<td style="border:1px solid black;">Cancelar</td><td style="border:1px solid black;">Localidad</td><td style="border:1px solid black;">Calle</td><td style="border:1px solid black;">Número</td><td style="border:1px solid black;">Piso</td><td style="border:1px solid black;">Letra</td><td style="border:1px solid black;">Num. habitaciones</td><td style="border:1px solid black;">Num. baños</td><td style="border:1px solid black;">Internet</td><td style="border:1px solid black;">Ascensor</td><td style="border:1px solid black;">Calefacción</td><td style="border:1px solid black;">Parking</td><td style="border:1px solid black;">Provincia</td><td style="border:1px solid black;">Precio</td><td style="border:1px solid black;">Tipo</td><td  style="border:1px solid black;">Estado  </td>
</tr>
...
if (mysqli_num_rows($resultado))
						...
						while($fila=mysqli_fetch_assoc($resultado)){
							...
							$id_arrendatario=$fila["ID_ARRENDATARIO"];
							$sql0="SELECT PHONE, MAIL FROM USERS WHERE ID_USER = " . $id_arrendatario;
							$resultado0 = mysqli_query($enlace,$sql0);
							$fila0=mysqli_fetch_assoc($resultado0);
							$tlf=$fila0["PHONE"];
							$email=$fila0["MAIL"];
							if ($fila["STATE"]==0)
								$estado="En espera";
							else
								$estado="Aceptado. TLF: " . $tlf . "<div>Email:". utf8_encode($email) . "</div>";
